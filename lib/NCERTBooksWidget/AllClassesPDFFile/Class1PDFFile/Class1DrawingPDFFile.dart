...
class Class1DrawingPDFFile extends StatefulWidget {
  const Class1DrawingPDFFile({Key key}) : super(key: key);

  @override
  _Class1DrawingPDFFileState createState() => _Class1DrawingPDFFileState();
}

class _Class1DrawingPDFFileState extends State<Class1DrawingPDFFile> {
  @override
