...
class Class4SciencePDFFile extends StatefulWidget {
  const Class4SciencePDFFile({Key key}) : super(key: key);

  @override
  _Class4SciencePDFFileState createState() => _Class4SciencePDFFileState();
}

class _Class4SciencePDFFileState extends State<Class4SciencePDFFile> {
  @override
