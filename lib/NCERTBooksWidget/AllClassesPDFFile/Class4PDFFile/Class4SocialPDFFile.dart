...
class Class4SocialPDFFile extends StatefulWidget {
  const Class4SocialPDFFile({Key key}) : super(key: key);

  @override
  _Class4SocialPDFFileState createState() => _Class4SocialPDFFileState();
}

class _Class4SocialPDFFileState extends State<Class4SocialPDFFile> {
  @override
