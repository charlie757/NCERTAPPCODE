...
class Class3SocialPDFFile extends StatefulWidget {
  const Class3SocialPDFFile({Key key}) : super(key: key);

  @override
  _Class3SSocialPDFFileState createState() => _Class3SSocialPDFFileState();
}

class _Class3SSocialPDFFileState extends State<Class3SocialPDFFile> {
  @override
