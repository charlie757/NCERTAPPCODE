...
class Class3SciencePDFFile extends StatefulWidget {
  const Class3SciencePDFFile({Key key}) : super(key: key);

  @override
  _Class3SciencePDFFileState createState() => _Class3SciencePDFFileState();
}

class _Class3SciencePDFFileState extends State<Class3SciencePDFFile> {
  @override
