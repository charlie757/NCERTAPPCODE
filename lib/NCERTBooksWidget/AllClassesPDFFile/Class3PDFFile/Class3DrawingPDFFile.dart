...
class Class3DrawingPDFFile extends StatefulWidget {
  const Class3DrawingPDFFile({Key key}) : super(key: key);

  @override
  _Class3DrawingPDFFileState createState() => _Class3DrawingPDFFileState();
}

class _Class3DrawingPDFFileState extends State<Class3DrawingPDFFile> {
  @override
