...
class Class5SocialPDFFile extends StatefulWidget {
  const Class5SocialPDFFile({Key key}) : super(key: key);

  @override
  _Class5SocialPDFFileState createState() => _Class5SocialPDFFileState();
}

class _Class5SocialPDFFileState extends State<Class5SocialPDFFile> {
  @override
