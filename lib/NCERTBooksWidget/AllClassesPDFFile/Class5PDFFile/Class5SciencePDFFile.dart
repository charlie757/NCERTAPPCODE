...
class Class5SciencePDFFile extends StatefulWidget {
  const Class5SciencePDFFile({Key key}) : super(key: key);

  @override
  _Class5SciencePDFFileState createState() => _Class5SciencePDFFileState();
}

class _Class5SciencePDFFileState extends State<Class5SciencePDFFile> {
  @override
