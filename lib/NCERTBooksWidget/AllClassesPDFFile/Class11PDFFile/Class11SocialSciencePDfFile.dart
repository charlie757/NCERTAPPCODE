...
class Class11SocialSciencePDFFile extends StatefulWidget {
  const Class11SocialSciencePDFFile({Key key}) : super(key: key);

  @override
  _Class11SocialSciencePDFFileState createState() =>
      _Class11SocialSciencePDFFileState();
}

class _Class11SocialSciencePDFFileState
    extends State<Class11SocialSciencePDFFile> {
  @override
