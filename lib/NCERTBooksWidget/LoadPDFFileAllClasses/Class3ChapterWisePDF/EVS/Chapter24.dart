...
class Chapter24 extends StatefulWidget {
  const Chapter24({Key key}) : super(key: key);

  @override
  _Chapter24State createState() => _Chapter24State();
}

class _Chapter24State extends State<Chapter24> {
  @override
  Widget build(BuildContext context) => Scaffold(
        appBar: AppBar(title: Text("Chapter-24")),
        body: Center(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                ButtonWidget(
                  text: 'PDF here',
                  onClicked: () async {
                    final url = 'Class3/EVS/ceap124.pdf';
