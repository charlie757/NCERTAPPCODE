...
class ChapterAns4 extends StatefulWidget {
  const ChapterAns4({Key key}) : super(key: key);

  @override
  _ChapterAns4State createState() => _ChapterAns4State();
}

class _ChapterAns4State extends State<ChapterAns4> {
  @override
            ...
            child: Column(
              ...
              children: [
                ...
                ButtonWidget(
                  text: 'PDF here',
                  onClicked: () async {
                    final url = 'Class11/chemistry/kech2in.pdf';
