...
class ChapterIntro2 extends StatefulWidget {
  const ChapterIntro2({Key key}) : super(key: key);

  @override
  _ChapterIntro2State createState() => _ChapterIntro2State();
}

class _ChapterIntro2State extends State<ChapterIntro2> {
  @override
            ...
            child: Column(
              ...
              children: [
                ...
                ButtonWidget(
                  text: 'PDF here',
                  onClicked: () async {
                    final url = 'Class11/chemistry/kech2ps.pdf';
