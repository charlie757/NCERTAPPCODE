...
class Chapter20 extends StatefulWidget {
  const Chapter20({Key key}) : super(key: key);

  @override
  _Chapter20State createState() => _Chapter20State();
}

class _Chapter20State extends State<Chapter20> {
  @override
  Widget build(BuildContext context) => Scaffold(
        appBar: AppBar(title: Text("Chapter-20")),
        body: Center(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                ButtonWidget(
                  text: 'PDF here',
                  onClicked: () async {
                    final url = 'Class11/biology/kebo120.pdf';
