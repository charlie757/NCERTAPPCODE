...
class ChapterLP extends StatefulWidget {
  const ChapterLP({Key key}) : super(key: key);

  @override
  _ChapterLPState createState() => _ChapterLPState();
}

class _ChapterLPState extends State<ChapterLP> {
  @override
            ...
            child: Column(
              ...
              children: [
                ...
                ButtonWidget(
                  text: 'PDF here',
                  onClicked: () async {
                    final url = 'Class10/Hindi/jhkr1LP.pdf';
