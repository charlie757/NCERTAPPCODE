...
class ChapterAns3 extends StatefulWidget {
  const ChapterAns3({Key key}) : super(key: key);

  @override
  _ChapterAns3State createState() => _ChapterAns3State();
}

class _ChapterAns3State extends State<ChapterAns3> {
  @override
  Widget build(BuildContext context) => Scaffold(
        appBar: AppBar(title: Text("Answer-3")),
        body: Center(
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                ButtonWidget(
                  text: 'PDF here',
                  onClicked: () async {
                    final url = 'Class10/Math/jemh1an.pdf';
