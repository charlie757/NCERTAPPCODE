...
class Class8ImportantBooks extends StatefulWidget {
  const Class8ImportantBooks({Key key}) : super(key: key);

  @override
  _Class8ImportantBooksState createState() => _Class8ImportantBooksState();
}

class _Class8ImportantBooksState extends State<Class8ImportantBooks> {
  @override
  Widget build(BuildContext context) {
    double width = MediaQuery.of(context).size.width;
    return Scaffold(
        appBar: AppBar(
          title: Text("Class VIII Important"),
        ),
