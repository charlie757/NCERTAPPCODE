...
class Class11BooksNotes extends StatefulWidget {
  const Class11BooksNotes({Key key}) : super(key: key);

  @override
  _Class11BooksNotesState createState() => _Class11BooksNotesState();
}

class _Class11BooksNotesState extends State<Class11BooksNotes> {
  @override
  Widget build(BuildContext context) {
    double width = MediaQuery.of(context).size.width;
    return Scaffold(
        appBar: AppBar(
          title: Text("Class XI Notes"),
        ),
