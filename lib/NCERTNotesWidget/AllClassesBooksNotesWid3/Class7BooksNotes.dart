...
class Class7BooksNotes extends StatefulWidget {
  const Class7BooksNotes({Key key}) : super(key: key);

  @override
  _Class7BooksNotesState createState() => _Class7BooksNotesState();
}

class _Class7BooksNotesState extends State<Class7BooksNotes> {
  @override
          ...
          child: Column(
            children: [
              ...
              Row(
                ...
                children: [
                  inkWell(width, context, 'English',
                      'assets/images/english1.jpg', Class12PhysicsPart()),
                ],
              ),
              SizedBox(height: 10),
              Container(
