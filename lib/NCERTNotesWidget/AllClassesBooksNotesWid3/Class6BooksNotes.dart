...
class Class6BooksNotes extends StatefulWidget {
  const Class6BooksNotes({Key key}) : super(key: key);

  @override
  _Class6BooksNotesState createState() => _Class6BooksNotesState();
}

class _Class6BooksNotesState extends State<Class6BooksNotes> {
  @override
  Widget build(BuildContext context) {
    double width = MediaQuery.of(context).size.width;
    return Scaffold(
        appBar: AppBar(
          title: Text("Class VI Notes"),
        ),
          ...
          child: Column(
            children: [
              ...
              Row(
                ...
                children: [
                  inkWell(width, context, 'Science',
                      'assets/images/science3.jpg', Class12PhysicsPart()),
                ],
              ),
              SizedBox(height: 10),
              Container(
