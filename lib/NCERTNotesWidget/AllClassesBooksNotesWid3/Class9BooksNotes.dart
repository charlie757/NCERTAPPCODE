...
class Class9BooksNotes extends StatefulWidget {
  const Class9BooksNotes({Key key}) : super(key: key);

  @override
  _Class9BooksNotesState createState() => _Class9BooksNotesState();
}

class _Class9BooksNotesState extends State<Class9BooksNotes> {
  @override
