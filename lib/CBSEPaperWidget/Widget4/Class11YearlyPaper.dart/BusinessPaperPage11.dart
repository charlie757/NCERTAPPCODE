...
class BusinessPaperPage11 extends StatefulWidget {
  const BusinessPaperPage11({Key key}) : super(key: key);

  @override
  _BusinessPaperPage11State createState() => _BusinessPaperPage11State();
}

class _BusinessPaperPage11State extends State<BusinessPaperPage11> {
  @override
  Widget build(BuildContext context) {
    double width = MediaQuery.of(context).size.width;
    return Scaffold(
        appBar: AppBar(
          title: Text("Business(XI)"),
        ),
        body: ListView(
          children: [
