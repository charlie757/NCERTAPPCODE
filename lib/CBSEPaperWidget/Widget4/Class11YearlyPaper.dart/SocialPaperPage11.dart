...
class SocialPaperPage11 extends StatefulWidget {
  const SocialPaperPage11({Key key}) : super(key: key);

  @override
  _SocialPaperPage11State createState() => _SocialPaperPage11State();
}

class _SocialPaperPage11State extends State<SocialPaperPage11> {
  @override
  Widget build(BuildContext context) {
    double width = MediaQuery.of(context).size.width;
    return Scaffold(
        appBar: AppBar(
          title: Text("Social Science(XI)"),
        ),
        body: ListView(
          children: [
