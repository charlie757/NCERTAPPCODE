...
class BiologyPaperPage11 extends StatefulWidget {
  const BiologyPaperPage11({Key key}) : super(key: key);

  @override
  _BiologyPaperPage11State createState() => _BiologyPaperPage11State();
}

class _BiologyPaperPage11State extends State<BiologyPaperPage11> {
  @override
  Widget build(BuildContext context) {
    double width = MediaQuery.of(context).size.width;
    return Scaffold(
        appBar: AppBar(
          title: Text("Biology(XI)"),
        ),
        body: ListView(
          children: [
