...
class PhysicsPaperPage11 extends StatefulWidget {
  const PhysicsPaperPage11({Key key}) : super(key: key);

  @override
  _PhysicsPaperPage11State createState() => _PhysicsPaperPage11State();
}

class _PhysicsPaperPage11State extends State<PhysicsPaperPage11> {
  @override
  Widget build(BuildContext context) {
    double width = MediaQuery.of(context).size.width;
    return Scaffold(
        appBar: AppBar(
          title: Text("Physics(XI)"),
        ),
        body: ListView(
          children: [
