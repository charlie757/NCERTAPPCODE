...
class HindiPaperPage11 extends StatefulWidget {
  const HindiPaperPage11({Key key}) : super(key: key);

  @override
  _HindiPaperPage11State createState() => _HindiPaperPage11State();
}

class _HindiPaperPage11State extends State<HindiPaperPage11> {
  @override
