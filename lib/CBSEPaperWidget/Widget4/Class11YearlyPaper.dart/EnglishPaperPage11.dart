...
class EnglishPaperPage11 extends StatefulWidget {
  const EnglishPaperPage11({Key key}) : super(key: key);

  @override
  _EnglishPaperPage11State createState() => _EnglishPaperPage11State();
}

class _EnglishPaperPage11State extends State<EnglishPaperPage11> {
  @override
  Widget build(BuildContext context) {
    double width = MediaQuery.of(context).size.width;
    return Scaffold(
        appBar: AppBar(
          title: Text("English(XI)"),
        ),
        body: ListView(
          children: [
