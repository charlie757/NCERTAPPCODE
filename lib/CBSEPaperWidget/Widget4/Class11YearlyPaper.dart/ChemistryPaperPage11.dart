...
class ChemistryPaperPage11 extends StatefulWidget {
  const ChemistryPaperPage11({Key key}) : super(key: key);

  @override
  _ChemistryPaperPage11State createState() => _ChemistryPaperPage11State();
}

class _ChemistryPaperPage11State extends State<ChemistryPaperPage11> {
  @override
  Widget build(BuildContext context) {
    double width = MediaQuery.of(context).size.width;
    return Scaffold(
        appBar: AppBar(
          title: Text("Chemistry(XI)"),
        ),
        body: ListView(
          children: [
