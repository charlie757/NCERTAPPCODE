...
class HindiPaperPage10 extends StatefulWidget {
  const HindiPaperPage10({Key key}) : super(key: key);

  @override
  _HindiPaperPage10State createState() => _HindiPaperPage10State();
}

class _HindiPaperPage10State extends State<HindiPaperPage10> {
  @override
