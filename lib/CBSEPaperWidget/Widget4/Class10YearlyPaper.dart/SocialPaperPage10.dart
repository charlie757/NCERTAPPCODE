...
class SocialPaperPage10 extends StatefulWidget {
  const SocialPaperPage10({Key key}) : super(key: key);

  @override
  _SocialPaperPage10State createState() => _SocialPaperPage10State();
}

class _SocialPaperPage10State extends State<SocialPaperPage10> {
  @override
  Widget build(BuildContext context) {
    double width = MediaQuery.of(context).size.width;
    return Scaffold(
        appBar: AppBar(
          title: Text("Social Science(X)"),
        ),
        body: ListView(
          children: [
