...
class MathPaperPage10 extends StatefulWidget {
  const MathPaperPage10({Key key}) : super(key: key);

  @override
  _MathPaperPage10State createState() => _MathPaperPage10State();
}

class _MathPaperPage10State extends State<MathPaperPage10> {
  @override
