...
class SocialPaperPage8 extends StatefulWidget {
  const SocialPaperPage8({Key key}) : super(key: key);

  @override
  _SocialPaperPage8State createState() => _SocialPaperPage8State();
}

class _SocialPaperPage8State extends State<SocialPaperPage8> {
  @override
  Widget build(BuildContext context) {
    double width = MediaQuery.of(context).size.width;
    return Scaffold(
        appBar: AppBar(
          title: Text("Social Science(VIII)"),
        ),
        body: ListView(
          children: [
