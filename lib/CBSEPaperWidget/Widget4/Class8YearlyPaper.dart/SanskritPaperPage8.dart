...
class SanskritPaperPage8 extends StatefulWidget {
  const SanskritPaperPage8({Key key}) : super(key: key);

  @override
  _SanskritPaperPage8State createState() => _SanskritPaperPage8State();
}

class _SanskritPaperPage8State extends State<SanskritPaperPage8> {
  @override
  Widget build(BuildContext context) {
    double width = MediaQuery.of(context).size.width;
    return Scaffold(
        appBar: AppBar(
          title: Text("Sanskrit(VIII)"),
        ),
        body: ListView(
          children: [
