...
class EnglishPaperPage8 extends StatefulWidget {
  const EnglishPaperPage8({Key key}) : super(key: key);

  @override
  _EnglishPaperPage8State createState() => _EnglishPaperPage8State();
}

class _EnglishPaperPage8State extends State<EnglishPaperPage8> {
  @override
  Widget build(BuildContext context) {
    double width = MediaQuery.of(context).size.width;
    return Scaffold(
        appBar: AppBar(
          title: Text("English(VIII)"),
        ),
        body: ListView(
          children: [
