...
class HindiPaperPage8 extends StatefulWidget {
  const HindiPaperPage8({Key key}) : super(key: key);

  @override
  _HindiPaperPage8State createState() => _HindiPaperPage8State();
}

class _HindiPaperPage8State extends State<HindiPaperPage8> {
  @override
  Widget build(BuildContext context) {
    double width = MediaQuery.of(context).size.width;
    return Scaffold(
        appBar: AppBar(
          title: Text("Hindi(VIII)"),
        ),
        body: ListView(
          children: [
