...
class HindiPaperPage12 extends StatefulWidget {
  const HindiPaperPage12({Key key}) : super(key: key);

  @override
  _HindiPaperPage12State createState() => _HindiPaperPage12State();
}

class _HindiPaperPage12State extends State<HindiPaperPage12> {
  @override
  Widget build(BuildContext context) {
    double width = MediaQuery.of(context).size.width;
    return Scaffold(
        appBar: AppBar(
          title: Text("Hindi(XII)"),
        ),
        body: ListView(
          children: [
