...
class BiologyPaperPage12 extends StatefulWidget {
  const BiologyPaperPage12({Key key}) : super(key: key);

  @override
  _BiologyPaperPage12State createState() => _BiologyPaperPage12State();
}

class _BiologyPaperPage12State extends State<BiologyPaperPage12> {
  @override
  Widget build(BuildContext context) {
    double width = MediaQuery.of(context).size.width;
    return Scaffold(
        appBar: AppBar(
          title: Text("Biology(XII)"),
        ),
        body: ListView(
          children: [
