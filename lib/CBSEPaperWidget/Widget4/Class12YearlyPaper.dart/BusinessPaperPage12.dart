...
class BusinessPaperPage12 extends StatefulWidget {
  const BusinessPaperPage12({Key key}) : super(key: key);

  @override
  _BusinessPaperPage12State createState() => _BusinessPaperPage12State();
}

class _BusinessPaperPage12State extends State<BusinessPaperPage12> {
  @override
  Widget build(BuildContext context) {
    double width = MediaQuery.of(context).size.width;
    return Scaffold(
        appBar: AppBar(
          title: Text("Business(XII)"),
        ),
        body: ListView(
          children: [
