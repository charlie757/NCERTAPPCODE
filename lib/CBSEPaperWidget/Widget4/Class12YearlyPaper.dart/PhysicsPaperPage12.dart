...
class PhysicsPaperPage12 extends StatefulWidget {
  const PhysicsPaperPage12({Key key}) : super(key: key);

  @override
  _PhysicsPaperPage12State createState() => _PhysicsPaperPage12State();
}

class _PhysicsPaperPage12State extends State<PhysicsPaperPage12> {
  @override
  Widget build(BuildContext context) {
    double width = MediaQuery.of(context).size.width;
    return Scaffold(
        appBar: AppBar(
          title: Text("Physics(XII)"),
        ),
        body: ListView(
          children: [
