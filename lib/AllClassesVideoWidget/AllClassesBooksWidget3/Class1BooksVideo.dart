...
class Class1BooksVideo extends StatefulWidget {
  const Class1BooksVideo({Key key}) : super(key: key);

  @override
  _Class1BooksVideoState createState() => _Class1BooksVideoState();
}

class _Class1BooksVideoState extends State<Class1BooksVideo> {
  @override
  Widget build(BuildContext context) {
    double width = MediaQuery.of(context).size.width;
    return Scaffold(
      appBar: AppBar(
        title: Text("Class I Video"),
      ),
      body: GridView(
        gridDelegate:
